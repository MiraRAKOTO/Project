...
import mg.douane.intervention.data.domaine.MailProperties;
...
public class SESService implements SendingMailService {
	...
	public boolean sendMail(String subject, String body) {
		try {
			...
			// props.put("mail.transport.protocol", "webmail");
			props.put("mail.transport.protocol", "smtp");
			props.put("mail.smtp.port", mailProperties.getSmtp().getPort());
			props.put("mail.smtp.starttls.enable", "true");
			props.put("mail.smtp.auth", "true");
			// props.put("mail.smtp.ssl.trust", "webmail.etechconsulting-mg.com");
